...
import ComapnyJobs from "./ComapnyJobs";
  ...
  return (
    <div className="w-3/4">
      <div className="relative">
        ...
        <img
          className="w-36 h-36 border-mine-shaft-950 p-2 bg-mine-shaft-950 border-8 absolute -bottom-1/4 left-5 rounded-3xl"
      ...
      <div>
        <Tabs
          variant="outline"
          radius="md"
          defaultValue={section[0].toLowerCase()}
        >
          <Tabs.List className="font-semibold [&_button[data-active='true']]:!border-b-mine-shaft-950 [&_button]:!text-xl mb-5 [&_button[data-active='true']]:text-bright-sun-400">
            {section.map((item, index) => (
              <Tabs.Tab key={index} value={item.toLowerCase()}>
                {item}
              </Tabs.Tab>
            ))}
          </Tabs.List>
